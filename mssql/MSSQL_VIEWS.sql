...
-- all person and role logic is procedural (see MSSQL_PROCEDURES.sql).
-- =============================================================================
...
-- -------------------------------------------------------------------------------
GO
-- Pivot table of ads by user type x ad type. ROLLUP adds a grand-total row,
-- labelled 'Total' where the grouping column comes back NULL.
...
CREATE OR ALTER VIEW vw_PendingRemoval AS
SELECT
    P.Building,
    P.BldgFloor,
    P.Slot,
